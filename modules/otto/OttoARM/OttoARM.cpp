...
void Otto::init(int YL, int YR, int RL, int RR, int LA, int RA, bool load_calibration, int NoiseSensor, int Buzzer, int USTrigger, int USEcho) {
...
unsigned long int Otto::getMouthShape(int number){
  unsigned long int types []={zero_code,one_code,two_code,three_code,four_code,smile_code,happyOpen_code,happyClosed_code,heart_code,bigSurprise_code,smallSurprise_code,tongueOut_code,
   lineMouth_code,confused_code,diagonal_code,sad_code,sadOpen_code,sadClosed_code,
...
void Otto::playGesture(int gesture){
  ...
  int sadPos[6]=      {110, 70, 20, 160, 90, 90};
  int bedPos[6]=      {100, 80, 60, 120, 90, 90};
  int fartPos_1[6]=   {90, 90, 145, 122, 90, 90}; //rightBend
  int fartPos_2[6]=   {90, 90, 80, 122, 90, 90};
  int fartPos_3[6]=   {90, 90, 145, 80, 90, 90};
  int confusedPos[6]= {110, 70, 90, 90, 90, 90};
  int angryPos[6]=    {90, 90, 70, 110, 90, 90};
  int headLeft[6]=    {110, 110, 90, 90, 90, 90};
  int headRight[6]=   {70, 70, 90, 90, 90, 90};
  int fretfulPos[6]=  {90, 90, 90, 110, 90, 90};
  int bendPos_1[6]=   {90, 90, 70, 35, 90, 90};
  int bendPos_2[6]=   {90, 90, 55, 35, 90, 90};
  int bendPos_3[6]=   {90, 90, 42, 35, 90, 90};
  int bendPos_4[6]=   {90, 90, 34, 35, 90, 90};
